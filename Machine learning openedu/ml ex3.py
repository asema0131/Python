...
import numpy as np
import pandas as pd
data = pd.read_csv("candy-test1.csv", encoding = 'utf-8', delimiter = ',', index_col='competitorname')
data_test = pd.read_csv("candy-test1.csv", encoding = 'utf-8', delimiter = ',', index_col='competitorname')
